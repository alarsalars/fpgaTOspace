...
set hasInterrupt 0
set C_modelName {second_func}
set C_modelType { int 2 }
set C_modelArgList {
	{ loop_bit uint 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "loop_bit", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ loop_bit sc_in sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "loop_bit", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "loop_bit", "role": "default" }} , 
...
set Spec2ImplPortList { 
	loop_bit { ap_none {  { loop_bit in_data 0 1 } } }
}
