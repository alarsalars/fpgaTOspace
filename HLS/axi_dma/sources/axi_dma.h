...
#define N       256                                         // Max nummber of read write burst, it has to be pow of 2 also not more than 256


typedef ap_uint<128>                            data_width;   // data package width per read/write
