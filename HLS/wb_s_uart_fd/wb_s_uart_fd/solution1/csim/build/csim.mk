...
HLS_SOURCES = ../../../source/top_tb.cpp ../../../source/top.cpp
...
$(ObjDir)/top_tb.o: ../../../source/top_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../source/top_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
