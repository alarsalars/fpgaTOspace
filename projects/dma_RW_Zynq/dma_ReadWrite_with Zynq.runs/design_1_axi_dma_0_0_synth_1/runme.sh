...
HD_PWD='C:/Users/TAlars/Documents/vivado_projects_tests/vipix/dma_ReadWrite_with Zynq/dma_ReadWrite_with Zynq/dma_ReadWrite_with Zynq.runs/design_1_axi_dma_0_0_synth_1'
cd "$HD_PWD"
